...
import com.mitsw.filemanager.R;
 ...
 *
 */
public final class Main extends GDActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //LinearLayout ll = (LinearLayout)findViewById(R.id.control_btn);
        ...
        mPathLabel.setText("path: /mnt/sdcard");
    ...
    private void prepareQuickActionGrid() {
        ...
        mGrid.addQuickAction(new MyQuickAction(this, R.drawable.gd_action_bar_home, R.string.gd_go_home));
        mGrid.addQuickAction(new MyQuickAction(this, R.drawable.gd_action_bar_eye, R.string.dir_info));
        
        mGrid.addQuickAction(new MyQuickAction(this, R.drawable.gd_action_bar_info, R.string.about));
    ...
    private OnQuickActionClickListener mActionListener = new OnQuickActionClickListener() {
        public void onQuickActionClicked(QuickActionWidget widget, int position) {
            //Toast.makeText(Main.this, "Item " + position + " clicked", Toast.LENGTH_SHORT).show();
            ...
            mHandler.ctlBtnEvent(img_button_id[position]);
    		...
    		case D_MENU_UNZIP:
    			if(mHoldingZip && mZippedTarget.length() > 1) {
    				...
    				if(new File(mZippedTarget).canRead() && new File(current_dir).canWrite()) {
	    				...
	    				mPathLabel.setText("path: "+current_dir);
