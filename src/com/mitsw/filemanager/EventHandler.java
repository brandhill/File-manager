...
public class EventHandler implements OnClickListener {
	...
	public void ctlBtnEvent(int resID) {
		...
		switch(resID) {
			...
			case R.id.home_button:		
				...
				stopThumbnailThread();
				updateDirectory(mFileMang.setHomeDir("/mnt/sdcard"));
				if(mPathLabel != null)
					mPathLabel.setText("path: "+mFileMang.getCurrentDir());
				break;
